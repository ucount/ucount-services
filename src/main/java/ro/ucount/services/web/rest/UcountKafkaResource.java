...
@RestController
@RequestMapping("/api/ucount-kafka")
public class UcountKafkaResource {

    private final Logger log = LoggerFactory.getLogger(UcountKafkaResource.class);
    ...
    public UcountKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
